...
export const actions = {
  ...
  bankCard: createAction(constants.BANK_CARD),
  bankCardSuccess: createAction(constants.BANK_CARD_SUCCESS),
  bankCardFailure: createAction(constants.BANK_CARD_FAILURE)
};
